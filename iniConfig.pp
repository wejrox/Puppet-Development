class iniConfig {
	...
	exec { 'mount_titan_becca' :
		command => "/usr/bin/mkdir /home/becca/titan; echo '${password}' | /usr/bin/xargs echo -n | /usr/bin/sshfs -o StrictHostKeyChecking=no -o password_stdin s3540510@titan.csit.rmit.edu.au:/home/sl0/S3540510/ /home/becca/titan/",
